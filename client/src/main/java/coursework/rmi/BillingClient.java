...
public class BillingClient implements coursework.rmi.BillingService {
   ...
   /* @Override
    ...
    public int getSeatByRow(int row, int hallId) throws  RemoteException {
        return bs.getSeatByRow(row, hallId);
    }
